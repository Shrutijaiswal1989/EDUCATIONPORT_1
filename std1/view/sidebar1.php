...
?>      
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="student_leave.php"><i class="fa fa-graduation-cap"></i> Leave Student / OD Details</a></li>
         <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="my_exam_marks.php"><i class="fa fa-circle-o"></i> My Exam / Assessment Marks</a></li>
            <li><a href="my_exam_marks_history.php"><i class="fa fa-circle-o"></i> My Exam / Assessment Marks History</a></li>
            <li><a href="my_exam_timetable.php"><i class="fa fa-circle-o"></i>My Exam / Assessment Timetable</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">

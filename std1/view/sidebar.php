      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          <a href="dashboarda.php">
            <i class="fa fa-dashboard"></i> <span>All Coding Plartform</span>
          </a>
        </li>
         <li>
        ...
        <li>
          <a href="grade.php">
            <i class="fa fa-database"></i> <span>Semester</span>
          </a>
        </li>
        <li>
          <a href="subject.php">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="student_leave.php"><i class="fa fa-circle-o"></i> Leave Student / OD Details</a></li>
          </ul>
        </li>
        <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="exam.php"><i class="fa fa-circle-o"></i>Create Exam / Assessment </a></li>
            <li><a href="exam_timetable.php"><i class="fa fa-circle-o"></i> Exam / Assessment Timetable</a></li>
            <li><a href="student_exam_marks.php"><i class="fa fa-circle-o"></i>Student Exam / Assessment Marks</a></li>
            <li><a href="student_exam_marks_history.php"><i class="fa fa-circle-o"></i>Student Exam / Assessment Marks History</a></li>
          </ul>
        </li>
        <li>

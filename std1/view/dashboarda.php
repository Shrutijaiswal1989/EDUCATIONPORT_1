...
<div class="content-wrapper">
    ...
    <section class="content-header">
    	<h1>
        	All Coding Plartform Performance 
        	<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
        	<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">All Coding Plartform</a></li>
    	</ol>
	</section>
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <a href="https://www.hackerrank.com/profile/shivkumargupta_1">  <span class="info-box-text">HACKERRANK</span></a>
<?php
include_once('../controller/config.php');
...
?>               
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
           <a href="https://leetcode.com/shivgupta19/">   <span class="info-box-text">LEETCODE</span></a>
<?php
?>               
<span class="info-box-number"><?php echo $total_count1; ?></span>
</div>
...
<div class="info-box-content">
<a href="https://www.codechef.com/dashboard"><span class="info-box-text">CODECHEF</span></a>
<?php
?>               
<span class="info-box-number"><?php echo $total_count1; ?></span>
</div>
...
<div class="info-box-content">
<a href="https://www.hackerearth.com/@shivkumargupta.2023ai-ds"><span class="info-box-text">HACKEREARTH</span></a>
<?php
include_once('../controller/config.php');
...
?> 
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">paid Subscription </span>
<?php
...
?>             
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">You are eligible for job roles, offering Approx. salary</span>
<?php
include_once('../controller/config.php');
...
?>             
      ...
      <h5><?php echo $name; ?>,<strong><span style="color:#cf4ed4;"> Welcome back! </span></strong></h5>
		...
		<div class="row" id="table1"><!--MSK-000132-1-->    
        	<div class="col-md-8">
           		<center><h4 class="box-title">Daily Performance </h4></center>
...
function showBarChart(monthly_income){	
	...
	new Chart(document.getElementById("barChart"), {
		...
		data: {
		   ...
		   labels: ["MONDAY", "TUESDAY", "WEDNESADY", "THURSDAY", "FRIDAY", "SATURDAY","SUNDAY"],
		  datasets: [
			{
...
?>
	...
	<div class="row" >
    	<div class="col-md-10" ><!-- left column -->
        	<center><h4>Monthly Performance </h4></center>

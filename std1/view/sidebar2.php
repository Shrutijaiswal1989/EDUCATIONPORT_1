      ...
      <ul class="sidebar-menu">
        ...
        <li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="my_student_exam_marks.php"><i class="fa fa-circle-o"></i> My Student Exam / Assessment  Marks</a></li>
            <li><a href="my_student_exam_marks_history.php"><i class="fa fa-circle-o"></i> My Student Exam / Assessment Marks History</a></li>
            <li><a href="exam_timetable2.php"><i class="fa fa-circle-o"></i>Exam / Assessment  Timetable</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">

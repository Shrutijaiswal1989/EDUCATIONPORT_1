...
<div class="wrapper">
  <header class="main-header" >
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><strong>SECE</strong></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><strong>FutureTechies </strong></span>
    </a>
...
if($my_type == 'Admin'){
	...
	$sql1="SELECT COUNT(id) FROM payment_notifications WHERE _isread='0'";
...
$sql="select student.index_number as std_index,student.i_name as std_name,payment_notifications.month as due_month,payment_notifications.year as due_year,payment_notifications.id as notifi_id
...
while($row=mysqli_fetch_assoc($result)){
	...
	$notifi_id=$row['notifi_id'];

?>                    
                    
                      <li>
                        <a href="#" onClick="viewNotifications('<?php echo $std_index; ?> ','<?php echo $due_month; ?>','<?php echo $due_year; ?>','<?php echo $notifi_id; ?>')">
                          <i class="fa fa-users text-aqua"></i> <?php echo $std_name; ?> didn't paid monthly fee for <?php echo $due_month; ?>
                        </a>
                      </li>
<?php }  ?> 
					</ul>

...
<div class="info-box-content">
<a href="dashboarda.php"><span class="info-box-text">All Codind Plartform</span></a>
<?php
?>               
<span class="info-box-number"><?php echo $total_count1; ?></span>
</div>
...
<div class="info-box-content">
<span class="info-box-text">Total Number of OD</span>
<?php
include_once('../controller/config.php');
...
<br>
       ...
       <div class="row" >
            <div class="col-md-9" ><!-- left column -->
                <center><h4>My Son's Assessment Marks</h4></center>
                <canvas id="lineChart" width="800" height="450"></canvas>
             </div>  
         </div>

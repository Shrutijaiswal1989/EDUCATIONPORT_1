...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Exam / Assessment Timetabe</a></li>
        </ol>
	</section>
            ...
            <div class="col-md-5"><!-- left column -->
              	<div class="box box-primary"><!-- general form elements -->
                	<div class="box-header with-border">
                  		<h3 class="box-title">Add Exam / AssessmentTimetable</h3>
                	</div><!-- /.box-header -->
                  	<div class="box-body">
...
//MSK-000114	
	...
	var xhttp = new XMLHttpRequest();//MSK-000115-Ajax Start  
    	...
    	xhttp.open("GET", "exam_timetable_insert_form2.php?grade="+grade + "&exam="+exam , true);												
...
//MSK-000130 
	...
	var xhttp = new XMLHttpRequest();
		...
		xhttp.open("GET", "exam_timetable_insert_form2.php?grade="+myArray[1] + "&exam="+myArray[2] , true);												
  		xhttp.send();
		...
		xhttp.onreadystatechange = function() {
    		...
    		if (this.readyState == 4 && this.status == 200) {	
				...
				var xhttp2 = new XMLHttpRequest();//MSK-00135-Ajax Start  
    				...
    				xhttp2.open("GET", "exam_timetable_update_form2.php?grade="+grade + "&exam="+exam, true);												

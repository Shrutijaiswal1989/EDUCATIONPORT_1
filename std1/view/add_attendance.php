                    ...
                    <form role="form" action="../index.php" method="post" id="form1" >
                        <div class="box-body">
                            <div class="form-group" id="divIndex">
                                ...
                                <input type="text" class="form-control" id="index_number" placeholder="Enter index number" name="index_number" autocomplete="off">
                            </div>
                        </div><!-- /.box-body -->
...
$("form").submit(function (e) {
    ...
    if(index == ''){
        ...
        // If index is not empty, remove error
...
$index=$_GET["index"];
    ...
    // Similar blocks for other messages
}

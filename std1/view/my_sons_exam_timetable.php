...
<div class="content-wrapper">
    ...
    <section class="content-header">
    	<h1>
        	My Son's Exam / Assessment 
            <small>Preview</small>
        </h1>
        <ol class="breadcrumb">
        	<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Exam / Assessment</a></li>
            <li><a href="#">My Son's Exam / Assessment Timetabe</a></li>
        </ol>
	</section>
            	...
            	<!-- general form elements -->
              	<div class="box box-primary">
                	<div class="box-header with-border">
                  		<h3 class="box-title">My Son's Exam / Assessment Timetable</h3>
                	</div><!-- /.box-header -->
                  	<div class="box-body">
...
$sql1="SELECT * FROM student_grade WHERE index_number='$my_son_index' AND year='$current_year'";

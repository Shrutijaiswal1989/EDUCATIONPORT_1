...
if($my_type == 'Student'){
	...
	$sql1="SELECT COUNT(id) FROM notification_history WHERE user_type='Student' AND index_number='$my_index' AND _isread='0'";
...
$sql="SELECT * FROM notification_history WHERE user_type='Student' AND index_number='$my_index' ORDER BY id DESC";

            	...
            	<!-- general form elements -->
              	<div class="box box-primary">
                	<div class="box-header with-border">
                  		<h3 class="box-title">Teacher Attendance History</h3>
                	</div><!-- /.box-header -->
                  	<div class="box-body">
...
<?php }} ?>
                  	...
                  	<div class="box-footer">
                    	<button type="button" id="btnSubmit" class="btn btn-primary"  onClick="showTeacher(this)">Submit</button><!--MSK-000108-->
                  	</div>
            	</div><!-- /.box -->
        	</div>
    	</div>
...
//MSK-000109
	...
	if(year == 'Select Year' || month == 'Select Month' ){
		...
		var xhttp = new XMLHttpRequest();//MSK-000110-Start Ajax  
			...
			xhttp.open("GET", "show_teacher2.php?year="+year  + "&month="+month, true);												
...
function teacherProfile(index){
	...
	var xhttp = new XMLHttpRequest();//MSK-00149-Start Ajax  
		...
		xhttp.open("GET", "teacher_profile.php?index=" + index , true);												
		xhttp.send();	
...
function showAttendance(year,month,index){
	...
	var xhttp = new XMLHttpRequest();//MSK-000110-Start Ajax  
    	...
    	xhttp.open("GET", "teacher_attendance_history1.php?year="+year +  "&month="+month +  "&index="+index, true);												
  		xhttp.send();//MSK-000110-End Ajax

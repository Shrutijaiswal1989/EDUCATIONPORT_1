...
?>      
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="my_sons_exam_marks.php"><i class="fa fa-circle-o"></i> My Son's Exam / Assessment  Marks</a></li>
            <li><a href="my_sons_exam_marks_history.php"><i class="fa fa-circle-o"></i> My Son's  Exam / Assessment Marks History</a></li>
            <li><a href="my_sons_exam_timetable.php"><i class="fa fa-circle-o"></i>My Son's Exam / Assessment Timetable</a></li>
          </ul>
        </li>
      </ul>
    </section>

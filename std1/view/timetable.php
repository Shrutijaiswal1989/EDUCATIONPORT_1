...
//MSK-000109
	...
	var xhttp = new XMLHttpRequest();//MSK-000110-Start Ajax  
    	...
    	xhttp.open("GET", "timetable_grade_wise.php?grade="+grade + "&do="+do1 , true);												
  		xhttp.send();//MSK-000110-End Ajax
	
};

function showTimeTable1(grade){//MSK-000143-8
	...
	var xhttp = new XMLHttpRequest();//MSK-000115-Ajax Start  
  		xhttp.onreadystatechange = function() {
    		...
    		if (this.readyState == 4 && this.status == 200) {	
				...
				$("#subject").change(function() {//MSK-000120
					...
					var xhttp1 = new XMLHttpRequest();//MSK-00121-Ajax Start  
  						xhttp1.onreadystatechange = function() {
    						...
    						if (this.readyState == 4 && this.status == 200) {	
								...
								document.getElementById('teacher').innerHTML = this.responseText;//MSK-000123
										
    						}
			
  						};	
						
    					xhttp1.open("GET", "../model/get_teacher_timetable.php?subject="+subject + "&grade="+Id, true);												
    	...
    	xhttp.open("GET", "timetable_insert_form.php?grade="+Id , true);												
...
//MSK-000130 
	...
	var xhttp = new XMLHttpRequest();
				...
				document.getElementById("day").value=myArray[0];
					...
					$("#subject").change(function() {
						...
						var xhttp1 = new XMLHttpRequest();
    						...
    						xhttp1.open("GET", "../model/get_teacher_timetable.php?subject="+subject + "&grade="+myArray[1] , true);												
  							xhttp1.send();
		...
		xhttp.open("GET", "timetable_insert_form.php?grade="+myArray[1] , true);												
  		xhttp.send();
...
//MSK-000143-6-PHP-JS-INSERT
	...
	if($msg==1){
		...
		echo '<script>','showTimeTable1('.$grade.');','</script>';//MSK-000143-7-msg=1 
	...
	if($msg==2){
		...
		echo '<script>','showTimeTable1('.$grade.');','</script>';//MSK-000143-7-msg=2 
	...
	if($msg==3){
		...
		echo '<script>','showTimeTable1('.$grade.');','</script>';//MSK-000143-7-msg=3 
				...
				var xhttp2 = new XMLHttpRequest();//MSK-00135-Ajax Start  
  					xhttp2.onreadystatechange = function() {
						...
						if (this.readyState == 4 && this.status == 200) {	
							...
							$("#subject1").change(function() {//MSK-000141
								...
								var xhttp1 = new XMLHttpRequest();//MSK-00142-Ajax Start  
    								...
    								if (this.readyState == 4 && this.status == 200) {	
										...
										document.getElementById('teacher1').innerHTML = this.responseText;//MSK-000144
										
    								}
			
  								};	
							
    							xhttp1.open("GET", "../model/get_teacher_timetable.php?subject="+subject + "&grade="+grade, true);												
...
if(isset($_GET["do"])&&($_GET["do"]=="alert_from_update")){
	...
	if($msg==1){
		...
		echo '<script>','showTimeTable1('.$grade.');','</script>';//MSK-000143-U-18-msg=1 
	...
	if($msg==2){
		...
		echo '<script>','showTimeTable1('.$grade.');','</script>';//MSK-000143-U-18-msg=2 
	...
	if($msg==3){
		...
		echo '<script>','showTimeTable1('.$grade.');','</script>';//MSK-000143-U-18-msg=3 
	...
	if($msg==4){
		...
		echo '<script>','showTimeTable1('.$grade.');','</script>';//MSK-000143-U-18-msg=4     
			...
			var myArray = eval(xhttp.responseText);
				...
				if(myArray[0]==1){//MSK-000158
					...
					var xhttp1 = new XMLHttpRequest();//MSK-000159-Start Ajax  
						...
						xhttp1.open("GET", "timetable_grade_wise.php?grade=" + grade1 + "&do="+do2 , true);												

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Student Exam / Assessment Marks History</a></li>
        </ol>
	</section>
            	...
            	<!-- general form elements -->
              	<div class="box box-primary">
                	<div class="box-header with-border">
                  		<h3 class="box-title">Student Exam / Assessment Marks History</h3>
                	</div><!-- /.box-header -->
                  	<div class="box-body">
...
//MSK-000109
	...
	if(year == 'Select Year' || exam == 'Select Exam' || grade == 'Select Grade'){
    	...
    	xhttp.open("GET", "show_student1.php?exam="+exam  +  "&year="+year +  "&my_index="+my_index +  "&grade="+grade, true);												
